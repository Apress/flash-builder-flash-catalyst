...
public class _Super_PersonDTO extends EventDispatcher implements IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void 
    {
        try 
        {
            if (flash.net.getClassByAlias("com.domain.project.services.PersonDTO") == null)
            {
                flash.net.registerClassAlias("com.domain.project.services.PersonDTO", cz);
            } 
        }
        catch (e:Error) 
        {
	...
	private var _internal_personId : Object;
	...
	[Bindable(event="propertyChange")] 
    public function get personId() : Object    
    {
    ...
    public function set personId(value:Object) : void 
    {    	
        var recalcValid:Boolean = false;
    	if (value == null || _internal_personId == null)
    	{
    		recalcValid = true;
    	}	
    	
    	
    	var oldValue:Object = _internal_personId;               
        if (oldValue !== value)
        {
   ...
   model_internal function setterListenerAnyConstraint(value:Event):void
   {
    ...
    model_internal function calculateIsValid():Boolean
    {
		...
		{
			violatedConsts.push("personIdIsRequired");
			validationFailureMessages.push("personId is required");
		}
