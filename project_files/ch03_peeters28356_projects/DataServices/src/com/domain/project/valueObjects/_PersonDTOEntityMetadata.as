...
internal class _PersonDTOEntityMetadata extends AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("personId", "id", "firstname", "lastname", "phone", "email");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("personId", "id", "firstname", "lastname", "phone", "email");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("personId", "id", "firstname", "lastname", "phone", "email");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("personId", "id", "firstname", "lastname", "phone", "email");
