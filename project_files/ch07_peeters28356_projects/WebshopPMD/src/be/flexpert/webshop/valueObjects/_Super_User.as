...
[ExcludeClass]
public class _Super_User extends EventDispatcher implements IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void 
    {
        try 
        {
            if (flash.net.getClassByAlias("be.flexpert.webshop.dtos.User") == null)
            {
                flash.net.registerClassAlias("be.flexpert.webshop.dtos.User", cz);
            } 
        }
        catch (e:Error) 
        {
    ...
    {    	
        var recalcValid:Boolean = false;
    	if (value == null || _internal_login == null)
    	{
    		recalcValid = true;
    	}	
    	
    	
    	var oldValue:Object = _internal_login;               
        if (oldValue !== value)
        {
   ...
   model_internal function setterListenerAnyConstraint(value:Event):void
   {
    ...
    model_internal function calculateIsValid():Boolean
    {
		...
		{
			violatedConsts.push("loginIsRequired");
			validationFailureMessages.push("login is required");
		}
