...
[ExcludeClass]
internal class _UserEntityMetadata extends AbstractEntityMetadata
{
	private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("email", "lastname", "login", "user_id", "firstname", "password");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("email", "lastname", "login", "user_id", "firstname", "password");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("email", "lastname", "login", "user_id", "firstname", "password");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("email", "lastname", "login", "user_id", "firstname", "password");
    ...
    [Bindable(event="propertyChange")]   
    public function get loginStyle():Style
    {
		return model_internal::_nullStyle;		
    }      
    
    [Bindable(event="propertyChange")]   
    public function get user_idStyle():Style
    {
		return model_internal::_nullStyle;		
    }      
