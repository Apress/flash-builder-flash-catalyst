...
{
	var w:Number = Math.floor(loader.width / 100 * slider.value);
	var h: Number = Math.floor(loader.height / 100 * slider.value);
	currentWidth.text = String(w);
	currentHeight.text = String(h);
	resizeImage(w, h);
}
